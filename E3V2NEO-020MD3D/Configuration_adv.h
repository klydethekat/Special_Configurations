 ...
 */
#define INPUT_SHAPING_X // KEN
#define INPUT_SHAPING_Y // KEN
#if EITHER(INPUT_SHAPING_X, INPUT_SHAPING_Y)
  #if ENABLED(INPUT_SHAPING_X)
    #define SHAPING_FREQ_X  60.15       // (Hz) The default dominant resonant frequency on the X axis. // KEN
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  60.15       // (Hz) The default dominant resonant frequency on the Y axis. // KEN
...
//define DISABLE_INACTIVE_Z  // Disable if the nozzle could fall onto your printed part! // KEN
...
//#define LIN_ADVANCE
  ...
  #define ALLOW_LOW_EJERK       // Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends. // KEN
...
#define ADVANCED_PAUSE_FEATURE  // MRiscoC Enabled
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     45  // (mm/s) Unload filament feedrate. This can be pretty fast.  // MRiscoC Increased filament unload speed // KEN
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      450  // (mm) The length of filament for a complete unload. // KEN
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  45  // (mm/s) Load filament feedrate. This can be pretty fast.  // MRiscoC Increased filament load speed // KEN
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   350  // (mm) Load length of filament, from extruder gear to nozzle. // KEN
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
